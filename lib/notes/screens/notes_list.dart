                      ...
                      children: <Widget>[
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            icon: IconButton(
                              onPressed: () => context.read<NotesCubit>().titleController.clear(),
                              icon: Icon(
                                Icons.clear,
                                color: Theme.of(context).colorScheme.surface,
                              ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            icon: IconButton(
                              onPressed: () => context.read<NotesCubit>().descriptionController.clear(),
                              icon: Icon(
                                Icons.clear,
                                color: Theme.of(context).colorScheme.surface,
                              ),
                    ...
                    builder: (context, state) {
                      return state.notes.isNotEmpty
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            final note = context.read<NotesCubit>().state.notes[index];
                                  ...
                                  child: Padding(
                                    ...
                                    child: Dismissible(
                                      ...
                                      onDismissed: (DismissDirection direction) async {
                                        await context.read<NotesCubit>().deleteNotes(note.description!);
                                      },
                                      child: GestureDetector(
                                        onTap: () {
                                          ...
                                          context.read<NotesCubit>().descriptionController.text = note.description!;
          ...
          child: ListView(
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    note.title = context.read<NotesCubit>().titleController.text.trim();
                    note.description = context.read<NotesCubit>().descriptionController.text.trim();
