...
final ThemeData blueTheme = ThemeData.light(
  ...
  highlightColor: const Color(0xffCDAD80).withOpacity(0.3),
...
final ThemeData brownTheme = ThemeData(
  ...
  highlightColor: const Color(0xffFFEEDC).withOpacity(0.3),
  ...
  disabledColor: const Color(0Xffffffff),
  hintColor: const Color(0xff77554B),
...
final ThemeData darkTheme = ThemeData.dark(
  ...
  highlightColor: const Color(0xff404C6E).withOpacity(0.3),
