                ...
                Column(
                  children: List.generate(
                    ...
                    (index) => Obx(
                      () => GestureDetector(
                        onTap: () {
                          QuranCtrl.instance.state.isBold.value = index.isEven
                              ? true
                              : false;
                          GetStorage().write(
                            IS_BOLD,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Get.isDarkMode
                            ? Theme.of(
                                context,
                              ).primaryColorDark.withValues(alpha: .5)
                            : Theme.of(
                                context,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Get.isDarkMode
                              ? Theme.of(
                                  context,
                                ).primaryColorDark.withValues(alpha: .7)
                              : Theme.of(
                                  context,
                  ...
                  children: [
                    ColorPicker(
                      ...
                      onColorChanged: (Color color) =>
                          quranCtrl.state.temporaryBackgroundColor.value = color
                              .toARGB32(),
                      pickersEnabled: {
