...
class AdhkarList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return context.customOrientation(
      Column(
        children: [const Gap(32), LogoWidget(), const Gap(32), ListBuild()],
      ),
      Row(
        children: [
          Expanded(flex: 4, child: ListBuild()),
          Expanded(flex: 4, child: LogoWidget()),
        ],
      ),
    );
  }
            ...
            child: Stack(
              ...
              children: [
                Transform.translate(
                  ...
                  child: RotatedBox(
                    quarterTurns: alignmentLayout(3, 1),
