...
part 'controller/assistant_state.dart';
part 'services/assistant_orchestrator.dart';
part 'services/bm25_service.dart';
part 'services/chat_history_service.dart';
part 'services/embedding_service.dart';
part 'services/heekmah_mcp_client.dart';
part 'services/model_download_service.dart';
part 'services/openrouter_service.dart';
part 'services/quotation_extractor.dart';
part 'services/search_section.dart';
part 'services/seerah_mcp_client.dart';
part 'services/tafsir_mcp_client.dart';
part 'services/unified_llm_service.dart';
part 'services/unified_orchestrator.dart';
...
part 'widgets/midad_note_widget.dart';
part 'widgets/model_selector_widget.dart';
part 'widgets/quotation_card.dart';
part 'widgets/section_download_card.dart';
part 'widgets/section_filter_widget.dart';
part 'widgets/streaming_result_card.dart';
part 'widgets/tool_call_indicator.dart';
part 'widgets/unified_assistant_view.dart';
