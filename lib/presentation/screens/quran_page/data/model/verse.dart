...
//     }
//     return SizedBox(
//       // height: orientation(context, 600.0, MediaQuery.sizeOf(context).height),
...
//                   horizontal: orientation(context, 0.0, 16.0),
//                 ),
//                 child: verses != null
//                     ? AspectRatio(
//                         aspectRatio: orientation(context, 5.7 / 9, 5.1 / 8),
//                         // aspectRatio: orientation(context, 2.20, 1.22),
//                         child: Transform.scale(
//                           scale: orientation(context, 1.03, 0.95),
//                           child: CustomPaint(
...
//               key: _imageKey,
//               child: Transform.scale(
//                 scale: orientation(context, 1.1, 1.0),
//                 child: Image.asset(
//                   widget.imageUrl,
//                   fit: BoxFit.contain,
...
//                       ? Colors.white
//                       : null,
//                   // width: sl<GeneralController>().width,
//                   alignment: Alignment.center,
//                 ),
//               ),
//             ),
