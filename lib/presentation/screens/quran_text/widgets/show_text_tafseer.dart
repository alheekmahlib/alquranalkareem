...
import '../../quran_page/widgets/change_tafsir.dart';
      ...
      child: SafeArea(
        child: Obx(() {
          ...
          if (ayat != null && ayat.length > ayatCtrl.numberOfAyahText.value) {
            ...
            // ayatCtrl.updateText("${aya.text}", "${aya.translate}");
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                child: Semantics(
                                                  ...
                                                  label: 'copy'.tr,
                                                  child:
                                                      share_icon(height: 25.0),
                                                ),
                                                onTap: () {
                                                  sl<ShareController>()
                                                      .changeTafseer(
                                                          context,
                                                          ayatCtrl.ayahUQNumber
                                                              .value,
                                                          ayatCtrl.surahNumber
                                                              .value,
                                                          ayatCtrl.ayahNumber
                                                              .value);
                                                  showVerseOptionsBottomSheet(
                                                      context,
                                                      ayatCtrl.ayahNumber.value,
                                                      ayatCtrl
                                                          .ayahUQNumber.value,
                                                      ayatCtrl
                                                          .surahNumber.value,
